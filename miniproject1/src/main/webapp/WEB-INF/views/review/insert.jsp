...
<body id="about" class="inner_page" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
        ...
        <thead>
          <tr>
            <td colspan="2">
              <a href='#' id="testBtn" class="btn"><i class="fa fa-map-marker"
                  style="font-size:25px; background:#fff;color:#f2184f;" aria-hidden="true"></i>
                <input autocomplete="off" type="text"
                  style="cursor:pointer;padding: 10px; border:0px; font-weight: bold;" required name="realresult"
                  id="realresult" placeholder="어디를 방문하셨나요?">
          ...
          <tr>
            ...
            <td>
              ...
              <i class="fas fa-star" style="color:rgb(253, 255, 106)"></i><i class="fas fa-star"
                style="color:rgb(253, 255, 106)"></i>
              <i class="fas fa-star" style="color:rgb(253, 255, 106)"></i><i class="fas fa-star"
                style="color:rgb(253, 255, 106)"></i>
          ...
          <tr>
            <td>내 용</td>
            <td><textarea name="content" id="content" rows="10" style="border:none;" cols="100"
                placeholder="하고픈 말을 작성해주세요" required></textarea></td>
  ...
  <div class="modal fade bd-example-modal-lg " id="testModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-body">
          ...
          <div style="display: inline-block; text-align: center; width: 100%; margin-top:10px;">
            <table id="resulttable" border="1"
              style="width:100%;vertical-align:middle; text-overflow:ellipsis; overflow:hidden;">
...
<script type="text/javascript"
  src="//dapi.kakao.com/v2/maps/sdk.js?appkey=073a87b4e20a3e00a4c2afca4e7cafca&libraries=services"></script>
<script>
  ...
  $(function () {
    ...
    $('#btn1').click(function () {//버튼을 클릭하면
      ...
      $.ajax({ //ajax 실행시킴
        type: 'GET',
        url: "https://dapi.kakao.com/v2/local/search/keyword.json?y=35.1633305253161&x=129.06315035329217&radius=1000&category_group_code=FD6&query=" + a,
